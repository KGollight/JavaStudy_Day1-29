...
public class Test22 {
	public static void main(String[] args) {
		...
		String[] result = util.work(pocketmon, search);
		util.print(result);
		
//		String[] result = util.search(pocketmon, search);
//		util.print(result);
//		
//		util.sort(result);
//		util.print(result);
//		
//		util.sortByIndex(result, search);
//		util.print(result);
//		
//		util.sortByApper(result, search);
//		util.print(result);
